					...
					<div class="nav-collapse collapse">
						<ul class="nav navbar-nav">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li>
										<a href="#">Excise for Manufacturer</a>
									</li>
									<li>
										<a href="#">Excise for Dealer</a>
									</li>
									<li class="divider"></li>
									<li>
										<a href="#">Value Added Tax</a>
									</li>
									<li class="divider"></li>
									<li>
										<a href="#">Tax Deducted at Source</a>
									</li>
									<li>
										<a href="#">Tax Collected at Source</a>
									</li>
									<li class="divider"></li>
									<li>
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li class="divider"></li>
									<li>
										<a href="#">Accounts Book</a>
									</li>
									<li>
										<a href="#">Statements of Accounts</a>
									</li>
									<li class="divider"></li>
									<li>
										<a href="#">Inventory books</a>
									</li>
									<li>
										<a href="#">Statements of Inventory</a>
									</li>
									<li class="divider"></li>
									<li>
										<a href="#">Cash/Funds Flow</a>
									</li>
									<li>
										<a href="#">Receipts and Payments</a>
									</li>
									<li class="divider"></li>
									<li>
		...
		<div id="footer">
			<div class="container">
				<p class="text-muted credit">
					Copyright © Cloud Solutions Pvt. Ltd.
				</p>
			</div>
		</div>
